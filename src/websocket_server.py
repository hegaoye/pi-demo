...
if __name__ == '__main__':
    ...
    logger.info("支持的事件:")
    logger.info("- chassis_control: 底盘控制 {direction: 'forward|reverse|turn_left|turn_right|start|pause|stop', speed: 0-100}")
